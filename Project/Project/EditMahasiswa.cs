...
Persist Security Info=False;";
        ...
        private void EditMahasiswa_Load(object sender, EventArgs e)
        {
            try
            {
                connection.Open();
            ...
            {
                MessageBox.Show("Combobox Error", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            connection.Close();
        }
        ...
        private void radButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ERROR Edit", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            connection.Close();
        }
    }
